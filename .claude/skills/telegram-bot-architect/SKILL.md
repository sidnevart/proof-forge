...
description: Design the Telegram bot's role, security model, capabilities, and integration boundaries.
---

## Purpose
- Use this skill to design the Telegram bot's role, security model, capabilities, and integration boundaries.

---
name: checkins-feature-builder
description: Design periodic check-in flows that anchor proof collection and progress continuity.
---

## Purpose
- Use this skill to design periodic check-in flows that anchor proof collection and progress continuity.

---
name: go-redis-builder
description: Design Redis usage for caching, locks, queues, or ephemeral coordination without hidden coupling.
---

## Purpose
- Use this skill to design Redis usage for caching, locks, queues, or ephemeral coordination without hidden coupling.

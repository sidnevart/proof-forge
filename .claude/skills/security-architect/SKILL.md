...
description: Design security controls for auth, authorization, secrets, file access, auditability, and abuse resistance.
---

## Purpose
- Use this skill to design security controls for auth, authorization, secrets, file access, auditability, and abuse resistance.

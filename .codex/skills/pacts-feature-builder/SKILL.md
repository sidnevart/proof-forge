---
name: pacts-feature-builder
description: Design the buddy pact model, roles, expectations, and lifecycle transitions.
---

## Purpose
- Use this skill to design the buddy pact model, roles, expectations, and lifecycle transitions.

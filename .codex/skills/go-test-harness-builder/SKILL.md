---
name: go-test-harness-builder
description: Define test helpers, fixtures, mocks, integration harnesses, and repeatable local backend verification.
---

## Purpose
- Use this skill to define test helpers, fixtures, mocks, integration harnesses, and repeatable local backend verification.

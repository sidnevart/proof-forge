...
description: Design dashboards that make product health, worker throughput, and failures obvious.
---

## Purpose
- Use this skill to design dashboards that make product health, worker throughput, and failures obvious.

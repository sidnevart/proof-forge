...
description: Define the HTTP server skeleton, routing, middleware, timeouts, and transport concerns.
---

## Purpose
- Use this skill to define the HTTP server skeleton, routing, middleware, timeouts, and transport concerns.

---
name: go-architecture-guardian
description: Protect backend boundaries, package discipline, and maintainable Go architecture as the codebase grows.
---

## Purpose
- Use this skill to protect backend boundaries, package discipline, and maintainable Go architecture as the codebase grows.
...
## Workflow
1. Load the local conventions, existing boundaries, and the proposed change.
2. Look for coupling, leakage, duplication, and future maintenance traps.
3. Separate hard blockers from optional polish.
4. State the correction in operational terms the implementer can act on.
5. Preserve good patterns instead of forcing unnecessary rewrites.

---
name: go-config-builder
description: Design the environment-driven configuration layer, validation rules, and config loading patterns.
---

## Purpose
- Use this skill to design the environment-driven configuration layer, validation rules, and config loading patterns.

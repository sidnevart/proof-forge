...
export const landingSignals = [
  ...
  "Партнёр остаётся источником решения по движению круга",
...
export const landingScenarios = [
  ...
  {
    title: "Держать круг под наблюдением вместе с партнёром",
...
export const proofEvents: ProofEvent[] = [
  {
    ...
    detail: "Загружены ссылки на экран и описание изменений по главному кругу.",
    status: "approved",
    time: "2 часа назад",
  },
  {

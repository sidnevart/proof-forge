---
name: go-validation-builder
description: Create request and domain validation patterns that fail clearly and protect business invariants.
---

## Purpose
- Use this skill to create request and domain validation patterns that fail clearly and protect business invariants.

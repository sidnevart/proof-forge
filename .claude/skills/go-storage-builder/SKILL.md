---
name: go-storage-builder
description: Design file and object storage handling for proof artifacts with safe uploads and retrieval boundaries.
---

## Purpose
- Use this skill to design file and object storage handling for proof artifacts with safe uploads and retrieval boundaries.

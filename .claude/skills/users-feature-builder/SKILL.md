---
name: users-feature-builder
description: Design the user account and profile slice with identity boundaries and onboarding needs.
---

## Purpose
- Use this skill to design the user account and profile slice with identity boundaries and onboarding needs.

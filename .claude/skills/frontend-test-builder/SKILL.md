---
name: frontend-test-builder
description: Design component, interaction, and regression tests for the frontend surface.
---

## Purpose
- Use this skill to design component, interaction, and regression tests for the frontend surface.

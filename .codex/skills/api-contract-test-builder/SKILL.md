---
name: api-contract-test-builder
description: Design contract verification for HTTP APIs, callbacks, and integration-facing payloads.
---

## Purpose
- Use this skill to design contract verification for HTTP APIs, callbacks, and integration-facing payloads.

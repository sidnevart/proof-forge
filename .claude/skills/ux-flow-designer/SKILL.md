...
description: Design end-to-end user flows for accountability setup, proof submission, buddy approval, and recap consumption.
---

## Purpose
- Use this skill to design end-to-end user flows for accountability setup, proof submission, buddy approval, and recap consumption.

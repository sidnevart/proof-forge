---
name: notification-scheduler-builder
description: Design the timing, batching, and policy rules behind reminders and recap dispatches.
---

## Purpose
- Use this skill to design the timing, batching, and policy rules behind reminders and recap dispatches.

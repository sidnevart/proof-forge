...
description: Protect clear frontend boundaries, state discipline, data flow, and maintainable component layering.
---

## Purpose
- Use this skill to protect clear frontend boundaries, state discipline, data flow, and maintainable component layering.

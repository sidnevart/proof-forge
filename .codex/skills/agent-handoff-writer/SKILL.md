---
name: agent-handoff-writer
description: Prepare precise handoff notes so the next agent or engineer can continue ProofForge work without re-discovery.
---

## Purpose
- Use this skill to prepare precise handoff notes so the next agent or engineer can continue ProofForge work without re-discovery.

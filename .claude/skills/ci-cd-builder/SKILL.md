---
name: ci-cd-builder
description: Design continuous integration and delivery pipelines with tests, artifacts, and release controls.
---

## Purpose
- Use this skill to design continuous integration and delivery pipelines with tests, artifacts, and release controls.

---
name: go-project-bootstrapper
description: Set up the baseline Go project structure, modules, entrypoints, and conventions for ProofForge services.
---

## Purpose
- Use this skill to set up the baseline Go project structure, modules, entrypoints, and conventions for ProofForge services.

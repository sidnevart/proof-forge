---
name: go-integration-test-builder
description: Design Go integration tests for persistence, HTTP contracts, jobs, and external boundaries.
---

## Purpose
- Use this skill to design Go integration tests for persistence, HTTP contracts, jobs, and external boundaries.

...
description: Build the practical observability stack wiring for logs, metrics, traces, and alerts.
---

## Purpose
- Use this skill to build the practical observability stack wiring for logs, metrics, traces, and alerts.

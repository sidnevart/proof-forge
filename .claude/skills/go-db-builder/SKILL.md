---
name: go-db-builder
description: Set up database access patterns, migrations, repositories, and transaction boundaries in Go.
---

## Purpose
- Use this skill to set up database access patterns, migrations, repositories, and transaction boundaries in Go.

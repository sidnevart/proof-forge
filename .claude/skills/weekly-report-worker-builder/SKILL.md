---
name: weekly-report-worker-builder
description: Design the background worker responsible for compiling and delivering weekly recap outputs.
---

## Purpose
- Use this skill to design the background worker responsible for compiling and delivering weekly recap outputs.

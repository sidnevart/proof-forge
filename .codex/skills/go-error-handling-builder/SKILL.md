---
name: go-error-handling-builder
description: Standardize typed errors, wrapping, user-safe messages, and operational diagnostics.
---

## Purpose
- Use this skill to standardize typed errors, wrapping, user-safe messages, and operational diagnostics.

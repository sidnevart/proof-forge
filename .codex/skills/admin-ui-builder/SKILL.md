...
description: Design the admin interface for support, oversight, moderation, and operational triage.
---

## Purpose
- Use this skill to design the admin interface for support, oversight, moderation, and operational triage.

---
name: migration-runner-builder
description: Design migration execution, locking, rollback policy, and operator safety checks.
---

## Purpose
- Use this skill to design migration execution, locking, rollback policy, and operator safety checks.

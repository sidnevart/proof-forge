---
name: go-unit-test-builder
description: Design precise unit tests for Go domain logic, services, and invariants.
---

## Purpose
- Use this skill to design precise unit tests for Go domain logic, services, and invariants.

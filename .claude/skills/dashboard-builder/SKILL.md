...
description: Design the main dashboard showing goals, proof cadence, buddy state, and recap visibility.
---

## Purpose
- Use this skill to design the main dashboard showing goals, proof cadence, buddy state, and recap visibility.

---
name: goal-ui-builder
description: Design the goal management surface for setup, editing, status, and proof expectations.
---

## Purpose
- Use this skill to design the goal management surface for setup, editing, status, and proof expectations.

---
name: async-jobs-architect
description: Design background job boundaries, retries, idempotency, and failure handling for recap and notification work.
---

## Purpose
- Use this skill to design background job boundaries, retries, idempotency, and failure handling for recap and notification work.

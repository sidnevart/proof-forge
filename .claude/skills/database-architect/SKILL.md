...
description: Design durable relational data structures, indexing strategy, and migration rules for ProofForge workloads.
---

## Purpose
- Use this skill to design durable relational data structures, indexing strategy, and migration rules for ProofForge workloads.

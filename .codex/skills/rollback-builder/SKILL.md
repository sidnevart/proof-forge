...
description: Design fast rollback procedures for app, database, infra, and webhook changes.
---

## Purpose
- Use this skill to design fast rollback procedures for app, database, infra, and webhook changes.

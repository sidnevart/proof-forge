...
description: Design realistic end-to-end tests covering the primary accountability loop across the stack.
---

## Purpose
- Use this skill to design realistic end-to-end tests covering the primary accountability loop across the stack.

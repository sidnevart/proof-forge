---
name: ai-summary-service-builder
description: Design the service that assembles context, calls models, stores outputs, and handles failures.
---

## Purpose
- Use this skill to design the service that assembles context, calls models, stores outputs, and handles failures.

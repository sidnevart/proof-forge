---
name: go-logger-builder
description: Create a structured logging strategy with request correlation, operational fields, and redaction rules.
---

## Purpose
- Use this skill to create a structured logging strategy with request correlation, operational fields, and redaction rules.

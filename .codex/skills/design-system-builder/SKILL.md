...
description: Define the reusable UI tokens, primitives, patterns, and accessibility rules for ProofForge surfaces.
---

## Purpose
- Use this skill to define the reusable UI tokens, primitives, patterns, and accessibility rules for ProofForge surfaces.

...
description: Review changes for auth, authorization, data exposure, file safety, abuse vectors, and secret handling.
---

## Purpose
- Use this skill to review changes for auth, authorization, data exposure, file safety, abuse vectors, and secret handling.

...
description: Design local multi-service composition for the ProofForge stack and developer workflows.
---

## Purpose
- Use this skill to design local multi-service composition for the ProofForge stack and developer workflows.
